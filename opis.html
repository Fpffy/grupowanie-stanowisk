...
<p class="description">
Jedną z takich metod jest określenie współczynika dla wszystkich wszystkich
...
<p class="description">
Wpółczynik podobieństwa należy policzyc dla wszystkich możliwych
par wyrobów. Wyniki najwygotniej przedstawic w tabeli
...
<ol class="list">
  <li>Wartości maksymalne wsółczyników podobieństwa dla każdej kolumny</li>
  <li>Wartośc minimalną z wyznaczonych wartości maksymalnych
    (graniczna wartośc współczynika podobieństwa)</li>
...
<h2>Ostatni etap: wydzielenie grup</h2>
<p>Mając tabele nr 3 możemy dokonac podziały na grupy. Przebiega on według
  nastepującego algorytmu:</p>
...
<script type="text/javascript" src="script-do-opisu.js"></script>
